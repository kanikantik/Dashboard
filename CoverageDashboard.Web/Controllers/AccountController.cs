...
using CoverageDashboard.Web.Controllers.Results;
using CoverageDashboard.Web.Models.Account;
...
{
    public class AccountController : CoverageDashboardControllerBase
    {
